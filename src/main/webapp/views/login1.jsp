...
<body>
	...
	<div class="textcentre">
		<div class="container" class="textcentre">
			    <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".1s">
						...
						<div class="ajax-hidden">
							<div class="form-group wow fadeInUp animated">
								...
								<input type="text"  placeholder="username" name="username" th:field="*{username}" class="form-control" id="username" required onblur="errorMessage()">

							<div data-wow-delay=".1s" class="form-group wow fadeInUp animated">
								<label for="password" class="sr-only">Password</label>
								<input type="password" placeholder="Password" name="password" th:field="*{password}" class="form-control" id="password" required>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".1s">
				<a href="dashboard"><button data-wow-delay=".3s" class="btn btn-sm btn-block wow fadeInUp animated" type="submit" >Login</button></a>
				</div>
				</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 wow bounceIn animated headding" data-wow-delay=".1s">
                   <p>Do not have an account<a href="login">Click here</a></p>
               </div>
				<span id="error"></span>
				</form>
				</div>
