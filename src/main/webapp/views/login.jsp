...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="/">Receipes</a>
                        </li>
                        <li>
	...
	<!-- =============== container =============== -->
		<div class="container">
			  ...
			  <form action="enter_details" th:action="@{/storedb}" th:object="${user}" method="post">
			...
			<div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".1s">
						...
						<div class="ajax-hidden">
							<div class="form-group wow fadeInUp animated">
								...
								<input type="text" placeholder="Name" name="cname" th:field="*{cname}" class="form-control" id="cname">
							</div>

							<div data-wow-delay=".1s" class="form-group wow fadeInUp animated">
								<label for="cemail" class="sr-only">Email</label>
								<input type="email" placeholder="E-mail" name="cemail" th:field="*{cemail}" class="form-control" id="cemail">
							</div>

							<div data-wow-delay=".1s" class="form-group wow fadeInUp animated">
								<label for="cphno" class="sr-only">Phone no</label>
								<input type="number" placeholder="Phn no" name="cphno" th:field="*{cphno}" class="form-control" id="cphno">
							</div>
						</div>
				...
				<div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".1s">
						...
						<div class="ajax-hidden">
							<div class="form-group wow fadeInUp animated">
								...
								<input type="text" placeholder="Username" name="username" th:field="*{username}" class="form-control" id="username">
							</div>

							<div data-wow-delay=".1s" class="form-group wow fadeInUp animated">
								<label for="password" class="sr-only">Password</label>
								<input type="password" placeholder="Password" name="password" th:field="*{password}" class="form-control" id="password" >
							</div>
						</div>
						<div class="ajax-response"></div>
					</div>
				...
				<div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".1s">
				<button data-wow-delay=".3s" class="btn btn-sm btn-block wow fadeInUp animated" type="submit">Sign Up</button>
				</div>
				</form>
